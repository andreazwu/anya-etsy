...
def seed_products():
  ...
  #4
  ghostmarsh = Product(
    seller_id=1, category="Halloween", name="Ghost marshmallows, set of three ghost marshmallows, Halloween decor, rae Dunn accessories, gift", description="With this set you'll receive a set of three of my fake marshmallows that are chocolate covered in black with cute ghost embellishments, on a stick with a Blk/white gingham bow", price=18.00, stock=20)

  #5
  ghostbanner = Product(
    seller_id=1, category="Halloween", name="Ghost banner, ghost garland, primitive ghost banner, vintage inspired Halloween banner, fall decor, gift, PREORDER", description="7 ghosts come on the banner. It comes strung on bakers twine. You can move the ghosts closer together or further apart.", price=51.75, stock=3)

  #6
  poisonapples = Product(
    seller_id=1, category="Halloween", name="Poison apples, fake food prop, fake apples, Halloween decor, fall decor, gift", description="FAKE FOOD DO NOT EAT!! These are my mini apples, the cutest fake poison apples! You'll receive 3 of these cuties! Gree. apples dipped in black, a cute Blk/white polka dot tie on each one", price=22.00, stock=20)

  #7
  halloweenwordsign = Product(
    seller_id=1, category="Halloween", name="Rae dunn inspired Halloween word signs, gift, farmhouse style", description="My mini word signs are perfect to put anywhere in your home. I have so many words to choose from or you can choose your own.", price=14.00, stock=25)
  ...
  #13
  valbanner = Product(
    seller_id=1, category="Valentine", name="Envelope felt banner, Valentine banner. Valentine decor, felt Valentine banner, felt envelope banner with pink hearts, gift, PREORDER", description="A sweet little banner for your Valentine decor. Each envelope is made from white felt. Each envelope has a wooden heart that's painted in a blush pink and it's strung on a blush pink yarn", price=33.00, stock=15)

  #14
  iloveyousign = Product(
    seller_id=1, category="Valentine", name="I love you sign, valentine sign, gift, romantic", description="7x7 inches; all paint and wood.", price=18.00, stock=3)

  #15
  valsticks = Product(
    seller_id=1, category="Valentine", name="Valentine pennant sticks, Valentine decor, pennant flags, gift, PREORDER", description="Decorate any space with these cutie pies! Two dowels that are adorably adorned with the cutest embellishments. Paper, wood letters & hearts, felt balls, yarn balls, ribbons etc", price=23.00, stock=3)

...
class SignUpForm(FlaskForm):
    ...
    email = StringField('email', validators=[DataRequired(), user_exists, Length(max=255, message="Email must be fewer than 255 characters"), Email(message="Email is not valid")])

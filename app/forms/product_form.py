...
class ProductForm(FlaskForm):
    ...
    price = DecimalField('price', places=2, validators=[DataRequired(), NumberRange(min=0.10, max=1000000, message="Price must be between $0.10 and $1,000,000")])
    stock = IntegerField('stock', validators=[DataRequired(), NumberRange(min=1, max=10000, message="Stock must be between 1 and 10000")])
